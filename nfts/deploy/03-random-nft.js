...
module.exports = async () => {
    ...
    const randomNumberContracts = contracts.RandomNumber
    const randomNumberContractAddress = randomNumberContracts[network.name].address

    const args = [randomNumberContractAddress, 10, 30, 60]
